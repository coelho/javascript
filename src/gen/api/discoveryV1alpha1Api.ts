...
import { V1alpha1EndpointSlice } from '../model/v1alpha1EndpointSlice';
import { V1alpha1EndpointSliceList } from '../model/v1alpha1EndpointSliceList';
...
export enum DiscoveryV1alpha1ApiApiKeys {
    BearerToken,
}

export class DiscoveryV1alpha1Api {
    ...
    public setApiKey(key: DiscoveryV1alpha1ApiApiKeys, value: string) {
        (this.authentications as any)[DiscoveryV1alpha1ApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async createNamespacedEndpointSlice (namespace: string, body: V1alpha1EndpointSlice, pretty?: string, dryRun?: string, fieldManager?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: V1alpha1EndpointSlice;  }> {
        const localVarPath = this.basePath + '/apis/discovery.k8s.io/v1alpha1/namespaces/{namespace}/endpointslices'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(body, "V1alpha1EndpointSlice")
        };
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1alpha1EndpointSlice;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "V1alpha1EndpointSlice");
    ...
    public async deleteNamespacedEndpointSlice (name: string, namespace: string, pretty?: string, dryRun?: string, gracePeriodSeconds?: number, orphanDependents?: boolean, propagationPolicy?: string, body?: V1DeleteOptions, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: V1Status;  }> {
        const localVarPath = this.basePath + '/apis/discovery.k8s.io/v1alpha1/namespaces/{namespace}/endpointslices/{name}'
    ...
    public async getAPIResources (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: V1APIResourceList;  }> {
        const localVarPath = this.basePath + '/apis/discovery.k8s.io/v1alpha1/';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
    ...
    public async listEndpointSliceForAllNamespaces (allowWatchBookmarks?: boolean, _continue?: string, fieldSelector?: string, labelSelector?: string, limit?: number, pretty?: string, resourceVersion?: string, timeoutSeconds?: number, watch?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: V1alpha1EndpointSliceList;  }> {
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1alpha1EndpointSliceList;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "V1alpha1EndpointSliceList");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject({ response: response, body: body });
     ...
     */
    public async patchNamespacedEndpointSlice (name: string, namespace: string, body: object, pretty?: string, dryRun?: string, fieldManager?: string, force?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: V1alpha1EndpointSlice;  }> {
        const localVarPath = this.basePath + '/apis/discovery.k8s.io/v1alpha1/namespaces/{namespace}/endpointslices/{name}'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)))
            .replace('{' + 'namespace' + '}', encodeURIComponent(String(namespace)));
        let localVarQueryParameters: any = {};
     ...
     */
    public async readNamespacedEndpointSlice (name: string, namespace: string, pretty?: string, exact?: boolean, _export?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: V1alpha1EndpointSlice;  }> {
        const localVarPath = this.basePath + '/apis/discovery.k8s.io/v1alpha1/namespaces/{namespace}/endpointslices/{name}'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)))
            .replace('{' + 'namespace' + '}', encodeURIComponent(String(namespace)));
        let localVarQueryParameters: any = {};
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async replaceNamespacedEndpointSlice (name: string, namespace: string, body: V1alpha1EndpointSlice, pretty?: string, dryRun?: string, fieldManager?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: V1alpha1EndpointSlice;  }> {
        const localVarPath = this.basePath + '/apis/discovery.k8s.io/v1alpha1/namespaces/{namespace}/endpointslices/{name}'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)))
            .replace('{' + 'namespace' + '}', encodeURIComponent(String(namespace)));
        let localVarQueryParameters: any = {};
